...
define('CMB_META_BOX_URL', get_stylesheet_directory_uri() . '/includes/metaboxes/');
    ...
    function show()
    {
        ...
        foreach ($this->_meta_box['fields'] as $field) {
            ...
            switch ($field['type']) {
                ...
                case 'email':
                    echo '<input type="email" name="', $field['id'], '" class="cmb_text_medium ', $class, '" id="', $field['id'], '" value="', '' !== $meta ? $meta : $field['std'], '" />', '<p class="cmb_metabox_description">', $field['desc'], '</p>';
                    break;
                case 'text':
                    echo '<input type="text" name="', $field['id'], '" class="', $class, '" id="', $field['id'], '" value="', '' !== $meta ? $meta : $field['std'], '" />', '<p class="cmb_metabox_description">', $field['desc'], '</p>';
                    break;
                case 'text_small':
                    echo '<input class="cmb_text_small ' . $class . '" type="text" name="', $field['id'], '" id="', $field['id'], '" value="', '' !== $meta ? $meta : $field['std'], '" /><span class="cmb_metabox_description">', $field['desc'], '</span>';
                    break;
                case 'text_medium':
                    echo '<input class="cmb_text_medium ' . $class . '" type="text" name="', $field['id'], '" id="', $field['id'], '" value="', '' !== $meta ? $meta : $field['std'], '" /><span class="cmb_metabox_description">', $field['desc'], '</span>';
                    break;
                case 'text_date':
                    echo '<input class="cmb_text_small cmb_datepicker ' . $class . '" type="text" name="', $field['id'], '" id="', $field['id'], '" value="', '' !== $meta ? $meta : $field['std'], '" /><span class="cmb_metabox_description">', $field['desc'], '</span>';
                    break;
                case 'text_date_timestamp':
                    echo '<input class="cmb_text_small cmb_datepicker ' . $class . '" type="text" name="', $field['id'], '" id="', $field['id'], '" value="', '' !== $meta ? date('m\/d\/Y', $meta) : $field['std'], '" /><span class="cmb_metabox_description">', $field['desc'], '</span>';
                    break;

                case 'text_datetime_timestamp':
                    echo '<input class="cmb_text_small cmb_datepicker ' . $class . '" type="text" name="', $field['id'], '[date]" id="', $field['id'], '_date" value="', '' !== $meta ? date('m\/d\/Y', $meta) : $field['std'], '" />';
                    echo '<input class="cmb_timepicker text_time ' . $class . '" type="text" name="', $field['id'], '[time]" id="', $field['id'], '_time" value="', '' !== $meta ? date('h:i A', $meta) : $field['std'], '" /><span class="cmb_metabox_description" >', $field['desc'], '</span>';
                    break;
                case 'text_time':
                    echo '<input class="cmb_timepicker text_time ' . $class . '" type="text" name="', $field['id'], '" id="', $field['id'], '" value="', '' !== $meta ? $meta : $field['std'], '" /><span class="cmb_metabox_description">', $field['desc'], '</span>';
                    break;
                case 'text_money':
                    echo '$ <input class="cmb_text_money ' . $class . '" type="text" name="', $field['id'], '" id="', $field['id'], '" value="', '' !== $meta ? $meta : $field['std'], '" /><span class="cmb_metabox_description">', $field['desc'], '</span>';
                    break;
                case 'colorpicker':
                    ...
                    echo '<input class="cmb_colorpicker cmb_text_small ' . $class . '" type="text" name="', $field['id'], '" id="', $field['id'], '" value="', $meta, '" /><span class="cmb_metabox_description">', $field['desc'], '</span>';
                    break;
                case 'textarea':
                ...
                case 'textarea_small':
                    ...
                    break;
                case 'textarea_code':
                    echo '<textarea name="', $field['id'], '" id="', $field['id'], '" cols="60" rows="10" class="cmb_textarea_code ' . $class . '">', '' !== $meta ? $meta : $field['std'], '</textarea>', '<p class="cmb_metabox_description">', $field['desc'], '</p>';
                    break;
                case 'select':
                    if (empty($meta) && !isset($_GET['post']) && !empty($field['std'])) {
                        $meta = $field['std'];
                    }
                ...
                case 'st_text_large':
                    ...
                    break;
                case 'st_meta_field':
                    $html = '<ul id="' . $field['id'] . '" class="meta-group">';
                    if ($meta != '') {
                        foreach ($meta as $meta_key => $meta_val) {
                            $html .= '
								<li id="meta-' . $meta_key . '">
									<span><label>Label</label> <input class="cmb_text_medium" type="text" name="' . $field['id'] . '[' . $meta_key . '][name]" value="' . $meta_val['name'] . '" /></span>
									<span><label>Value</label> <input class="cmb_text_medium" type="text" name="' . $field['id'] . '[' . $meta_key . '][value]" value="' . $meta_val['value'] . '" /></span>
                        ...
                        $html .= '
							<li id="meta-' . $meta_key . '">
								<span><label>Label</label> <input class="cmb_text_medium" type="text" name="' . $field['id'] . '[' . $meta_key . '][name]" value="" /></span>
								<span><label>Value</label> <input class="cmb_text_medium" type="text" name="' . $field['id'] . '[' . $meta_key . '][value]" value="" /></span>
								<button class="button-secondary meta_delete_button">Delete</button>
							</li>
							';
                    }
                    $html .= '</ul>';
                    $html .= '<button class="button-primary meta_add_button">Add More Meta</button>';
                    echo $html;
                    break;
                case 'st_social_icons':
                    $html      = '<ul id="' . $field['id'] . '" class="meta-group">';
                    $getSocial = rove_get_socials();
                    unset($getSocial['rss']);
                    foreach ($getSocial as $k => $v) {
                        $url = ($meta != '') ? $meta[$k] : '';
                        $html .= '
								<li id="social-' . $k . '">
									<span><label style="display:inline-block;width:100px;">' . $v[1] . ' URL</label> <input class="cmb_text_medium" type="text" name="' . $field['id'] . '[' . $k . ']" value="' . $url . '" /></span>
								</li>';
                    }
                    $html .= '</ul>';
                    echo $html;
                    break;
                case 'st_image_single':
                    echo '<input id="', $field['id'], '" type="hidden" name="', $field['id'], '" value="', $meta, '" />';
                    echo '<input class="cmb_image_single button" type="button" value="Select or Upload Images" />';
                    echo '<p class="cmb_metabox_description">', $field['desc'], '</p>';
                    echo '<div id="', $field['id'], '_status" class="cmb_media_status">';
                    if ($meta != '') {
                        $thumbURL = wp_get_attachment_image_src($meta, 'thumbnail');
                        echo '<div class="img_status img_post">';
                        echo '<img src="', $thumbURL[0], '" alt="" />';
                        echo '<a href="#" class="cmb_remove_file_button" rel="', $field['id'], '">Remove Image</a>';
                        echo '</div>';
                    }
                    echo '</div>';
                    break;
                case 'st_image_gallery':
                    echo '<input id="', $field['id'], '" class="cmb_image_gallery button" type="button" value="Select or Upload Images" />';
                    echo '<p class="cmb_metabox_description">', $field['desc'], '</p>';
                    echo '<div id="', $field['id'], '_status" class="cmb_media_status sortable">';
                    if ($meta != '') {
                        foreach ($meta as $meta_key => $meta_id) {
                            $thumbURL = wp_get_attachment_image_src($meta_id, 'thumbnail');
                            echo '<div class="img_status img_post">';
                            echo '<input type="hidden" name="', $field['id'], '[]" value="', $meta_id, '" />';
                            echo '<img src="', $thumbURL[0], '" alt="" />';
                            echo '<a href="#" class="cmb_remove_image_button">Remove Image</a>';
                            echo '</div>';
                        }
                    }
                ...
                case 'st_image_field':
                    ...
                    echo '<input class="cmb_image_field button" type="button" value="Select or Upload Images" />';
                    echo '<p class="cmb_metabox_description">', $field['desc'], '</p>';
                    echo '<div id="', $field['id'], '_status" class="cmb_media_status">';
                    if ($meta != '') {
                        echo '<div class="img_status">';
                ...
                case 'st_background_simple':
                    ...
                    if (!is_array($meta)) {
                        if ($field['type'] == 'st_background_simple') {
                            $meta = array('background-color' => '', 'background-image' => '');
                        } else {
                            $meta = array('background-color' => '', 'background-image' => '', 'background-repeat' => '', 'background-size' => '', 'background-attachment' => '', 'background-position' => '');
                        }
                    }
                    $hex_color = '(([a-fA-F0-9]){3}){1,2}$';
                    if (preg_match('/^' . $hex_color . '/i', $meta['background-color'])) // Value is just 123abc, so prepend #.
                    {
                        $meta['background-color'] = '#' . $meta['background-color'];
                    } elseif (!preg_match('/^#' . $hex_color . '/i', $meta['background-color'])) // Value doesn't match #123abc, so sanitize to just #.
                    {
                        $meta['background-color'] = "";
                    } //$meta['background-color'] = "#";
                    echo '<input class="cmb_colorpicker cmb_text_small" type="text" name="', $field['id'], '[background-color]" id="', $field['id'], '_color" value="', $meta['background-color'], '" />';
                    echo '<div style="height:10px;">&nbsp;</div>';

                    echo '<input class="cmb_upload_file" type="text" size="45" id="', $field['id'], '" name="', $field['id'], '[background-image]" value="', $meta['background-image'], '" />';
                    echo '<input class="cmb_image_field button" type="button" value="Select or Upload Images" />';
                    echo '<p class="cmb_metabox_description">', $field['desc'], '</p>';
                    echo '<div id="', $field['id'], '_status" class="cmb_media_status">';
                    if ($meta['background-image'] != '') {
                        echo '<div class="img_status">';
                        echo '<img src="', $meta['background-image'], '" alt="" />';
                        echo '<a href="#" class="cmb_remove_file_button" rel="', $field['id'], '">Remove Image</a>';
                        echo '</div>';
                    }
                    echo '</div>';

                    if ($field['type'] == 'st_background') {
                        // Background Repeat
                        echo '<select class="select of-background of-background-repeat" name="' . $field['id'] . '[background-repeat]" id="' . $field['id'] . '_repeat">';
                        echo '<option value=""></option>';
                        $repeats = $style_bg_repeat;
                        foreach ($repeats as $key => $repeat) {
                            echo '<option value="', $key, '"', $meta['background-repeat'] == $key ? ' selected="selected"' : '', '>', $repeat, '</option>';
                        }
                        echo '</select>';

                        // Background Size
                        echo '<select class="select of-background of-background-size" name="' . $field['id'] . '[background-size]" id="' . $field['id'] . '_size">';
                        echo '<option value=""></option>';
                        $sizes = $style_bg_size;
                        foreach ($sizes as $key => $size) {
                            echo '<option value="', $key, '"', $meta['background-size'] == $key ? ' selected="selected"' : '', '>', $size, '</option>';
                        }
                        echo '</select>';

                        // Background Attachment
                        echo '<select class="select of-background of-background-attachment" name="' . $field['id'] . '[background-attachment]" id="' . $field['id'] . '_attachment">';
                        echo '<option value=""></option>';
                        $attachments = $style_bg_attachment;
                        foreach ($attachments as $key => $attachment) {
                            echo '<option value="', $key, '"', $meta['background-attachment'] == $key ? ' selected="selected"' : '', '>', $attachment, '</option>';
                        }
                        echo '</select>';

                        // Background Position
                        echo '<select class="select of-background of-background-position" name="' . $field['id'] . '[background-position]" id="' . $field['id'] . '_position">';
                        echo '<option value=""></option>';
                        $positions = $style_bg_position;
                        foreach ($positions as $key => $position) {
                            echo '<option value="', $key, '"', $meta['background-position'] == $key ? ' selected="selected"' : '', '>', $position, '</option>';
                        }
                        echo '</select>';
                    }
                    break;
